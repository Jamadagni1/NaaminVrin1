document.addEventListener('DOMContentLoaded', () => {
    ...
    const rashiMap = [
        ...
        },
        {
            ...
            traits_hi: "आशावादी, दार्शनिक और स्वतंत्र। आप सत्य और रोमांच की खोज में रहते हैं। आपकी उत्साही भावना और स्वतंत्रता के प्रति प्रेम आपको सभी के लिए प्रेरणा का स्र��त बनाता है।"
        },
        {
    ...
    const updateContent = (lang) => {
        ...
        if (nameInput) nameInput.placeholder = isHindi ? "उदा: ��रव या आ" : "e.g. Aarav or Aa";
